...
///
/// The scaffolded `pubspec.yaml` already declares the code-generation
/// dev-dependencies, so `ratel dev` works immediately and the application never
/// has to know that generation happens at all.
...
# Generated by `ratel dev` / `ratel build`
*.ratel.dart
''');
