...
abstract final class OpenApiSpec {
  ...
  static Map<String, dynamic> _operation(Route route) {
  ...
  static Map<String, dynamic> _parameter(RouteParameter parameter) => {
        'name': parameter.name,
  ...
  static String _openApiPath(String path) => path
      .split('/')
      .map((s) => s.startsWith(':') ? '{${s.substring(1)}}' : s)
      .join('/');

  static String _schemaType(Type type) {
