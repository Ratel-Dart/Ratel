...
abstract final class StaticFilesMiddleware {
  static const _utf8Types = {'application/javascript', 'application/json'};
  ...
  static String? _relativePath(String path, String urlPrefix) {
  ...
  static Future<String?> _resolveRoot(Directory root) async {
    try {
