...
import '../support/fixtures/controllers/event_stream_controller.dart';
import '../support/fixtures/definitions/event_stream_controller_definition.dart';
...
void main() {
  ...
  final server = RatelServer(
    ...
    registry: RatelRegistry.fromManifest(
      const RatelManifest(controllers: [EventStreamControllerDefinition.value]),
    ),
  );
  ...
  setUpAll(() async {
    Injector.ambient = Injector.scoped()
      ..put<EventStreamController>(
        () => EventStreamController(ticks.stream, held.stream),
      );
