...
import '../support/fixtures/codecs/limited_note_codec.dart';
import '../support/fixtures/definitions/limited_note_controller_definition.dart';
...
void main() {
  final server = RatelServer(
    ...
    registry: RatelRegistry.fromManifest(
      const RatelManifest(
        controllers: [LimitedNoteControllerDefinition.value],
        jsonCodecs: [LimitedNoteCodec.definition],
      ),
    ),
  );
